...
- Computes player-level statistics (average placement, win rate, match history)  
...
- Transforms deeply nested JSON into a structured relational format  
- Stores data in PostgreSQL using a normalized schema for efficient queries  
...
- Debugged distributed system issues across container orchestration, networking, and database connectivity

## Future Work
- Add HTTPS with custom domain and SSL via AWS Certificate Manager
- Implement CI/CD pipeline using GitHub Actions
- Introduce database migrations using Alembic
- Add caching layer (e.g., Redis) for performance optimization

## Author
Jeff Jimenez
github.com/jefferinooo
